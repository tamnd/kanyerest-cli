...
func TestHostWiring(t *testing.T) {
	...
	if want := "kanyerest://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("kanyerest", "about")
	if err != nil || got.String() != "kanyerest://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want kanyerest://page/about", got.String(), err)
	}
}
