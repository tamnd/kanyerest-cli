...
```
kanyerest <command> [arguments] [flags]
```

Run `kanyerest <command> --help` for the full flag list on any command. This
...
per operation you declare in `kanyerest/domain.go`.
