...
Most of these come down to network reality or how kanyerest serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

kanyerest rate-limits like any public site. kanyerest already paces
...
Where a surface is gated, kanyerest reads a cookie or token you supply
...
`kanyerest`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what kanyerest actually did
